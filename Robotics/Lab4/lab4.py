...
# the gravitational force exactly
#
...
#
# In order to get smoother curves I break each curve into 10 and linearly interpolate over the curve.
# In other words I have an interpolation value that goes from 0 to 1 and increments by 0.1 for each
