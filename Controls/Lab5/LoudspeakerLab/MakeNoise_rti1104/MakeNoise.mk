...
#
#  $RCSfile: MakeNoise.mk $ $Revision: 2.40 $ $Date: 2010/06/17 13:44:29CEST $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Distribution/MATLAB/RTI1104/M/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 150
# =============================================================================
...
MATLAB_ROOT                    = C:\Program Files (x86)\MATLAB\R2010bSP1
MATLAB_BIN                     = C:\Program Files (x86)\MATLAB\R2010bSP1\bin
MATLAB_ROOT_ALT                = C:\PROGRA~2\MATLAB\R2010B~1
MATLAB_BIN_ALT                 = C:\PROGRA~2\MATLAB\R2010B~1\bin
RELEASE_VERSION                = R2010bSP11
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = MakeNoise
MODULES                        = MakeNoise_data.c MakeNoise_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
LNK_OPTS =  -QmsA0314 -QmeA0307 -QmeA0329
