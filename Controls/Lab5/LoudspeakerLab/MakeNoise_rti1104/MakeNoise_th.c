/************************ dSPACE target specific file *************************
   ...
   Include file .\makenoise_rti1104\MakeNoise_th.c :

   Task Configuration file for model : MakeNoise

   RTI1104 6.6 (29-Nov-2010)/2.3
   04-Oct-2017 10:24:11
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\makenoise_rti1104\MakeNoise_th.c is for ST).
# endif
